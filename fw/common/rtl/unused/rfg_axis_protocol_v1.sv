...
module rfg_axis_protocol  #(
    ...
    input  wire [7:0]               rfg_read_value
        ...
        always_comb begin
            switch_m_axis_if.tvalid = !read_buffer_empty;
            switch_m_axis_if.tdata = read_buffer_data_out;
            //switch_m_axis_if.tvalid
        end
            ...
            if (aresetn==0) begin
                ...
                case (rfp_state)
                    ...
                    RFP_READ_FINISH: begin
                        ...
                        if (/*read_buffer_empty &&*/ rfg_master_length==1 && m_axis_write_valid) begin
                            rfp_state               <= RFP_HEADER;
                        end
                    end
                    RFP_READ: begin
