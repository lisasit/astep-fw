...
set_property -dict {PACKAGE_PIN G4 IOSTANDARD LVCMOS25} [get_ports resn ]  ; # sch=cpu_resetn
...
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS25} [get_ports layers_inj]
}
set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS25} [get_ports layers_sr_rb]
set_property -dict {PACKAGE_PIN D17 IOSTANDARD LVCMOS25} [get_ports layers_sr_sout0]
...
set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS25} [get_ports layers_resn]

set_property -dict {PACKAGE_PIN A19 IOSTANDARD LVCMOS25} [get_ports timestamp_clk]

# Reverse hold <-> interrupt switch from V2
# Reverse hold <-> interrupt switch from V2
if {${chipversion} == 3} {
    set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS25} [get_ports layers_hold]; #IO_L18P_T2_16 Sch=fmc_la_p[20]
    set_property -dict {PACKAGE_PIN B17 IOSTANDARD LVCMOS25} [get_ports layer_0_interruptn]; #IO_L12P_T1_MRCC_16 Sch=fmc_la18_cc_p
} elseif {${chipversion} == 2} {
    set_property -dict {PACKAGE_PIN B17 IOSTANDARD LVCMOS25} [get_ports layer_0_interruptn]; #IO_L18P_T2_16 Sch=fmc_la_p[20]
    set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS25} [get_ports layers_hold]; #IO_L12P_T1_MRCC_16 Sch=fmc_la18_cc_p
}
...
# SPI left
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS25} [get_ports layer_0_spi_clk]
set_property -dict {PACKAGE_PIN B16 IOSTANDARD LVCMOS25} [get_ports layers_spi_csn]
set_property -dict {PACKAGE_PIN D21 IOSTANDARD LVCMOS25} [get_ports {layer_0_spi_miso[0]}]
set_property -dict {PACKAGE_PIN E21 IOSTANDARD LVCMOS25} [get_ports {layer_0_spi_miso[1]}]
set_property -dict {PACKAGE_PIN F19 IOSTANDARD LVCMOS25} [get_ports layer_0_spi_mosi]

#SPI right
set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS25} [get_ports layer_0_spi_right_mosi]
set_property -dict {PACKAGE_PIN H22 IOSTANDARD LVCMOS25} [get_ports layer_0_spi_right_csn]
set_property -dict {PACKAGE_PIN J22 IOSTANDARD LVCMOS25} [get_ports {layer_0_spi_right_miso[0]}]
set_property -dict {PACKAGE_PIN G18 IOSTANDARD LVCMOS25} [get_ports {layer_0_spi_right_miso[1]}]
set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS25} [get_ports layer_0_spi_right_clk]
