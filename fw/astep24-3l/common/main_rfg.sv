module main_rfg(
    ...
    input  logic                  clk,
    input  logic                  resn,
    input  logic [15:0]         rfg_address,
    output logic                  rfg_address_valid,
    input  logic [7:0]          rfg_write_value,
    output logic                  rfg_write_valid,
    input  logic                  rfg_write,
    input  logic                  rfg_write_last,
    input  logic                  rfg_read,
    output logic                  rfg_read_valid,
    output logic [7:0]          rfg_read_value,

    output logic [7:0]           chip_version,
    output logic [7:0]           clock_ctrl,
    output logic                   clock_ctrl_ext_clk_enable,
    output logic                   clock_ctrl_ext_clk_differential,
    input  logic                   clock_ctrl_current_clk,
    output logic                   clock_ctrl_sample_clock_enable,
    output logic                   clock_ctrl_timestamp_clock_enable,
    input  logic [15:0]            hk_xadc_temperature,
    input  logic                  hk_xadc_temperature_write,
    input  logic [15:0]            hk_xadc_vccint,
    input  logic                  hk_xadc_vccint_write,
    output logic [31:0]           hk_conversion_trigger,
    output logic                  hk_conversion_trigger_interrupt,
    input  logic                  hk_stat_conversions_counter_enable,
    output logic [7:0]           hk_ctrl,
    output logic                   hk_ctrl_select_adc,
    ...
    input  logic                  hk_adcdac_mosi_fifo_m_axis_tready,
    output logic            hk_adcdac_mosi_fifo_m_axis_tlast,
    // AXIS Slave interface to read from FIFO hk_adc_miso_fifo,
    // --------------------,
    input  logic [7:0]            hk_adc_miso_fifo_s_axis_tdata,
    input  logic                  hk_adc_miso_fifo_s_axis_tvalid,
    output logic                  hk_adc_miso_fifo_s_axis_tready,
    input  logic [31:0]            hk_adc_miso_fifo_read_size,
    input  logic                  hk_adc_miso_fifo_read_size_write,
    input  logic            spi_layers_ckdivider_source_clk,
    input  logic            spi_layers_ckdivider_source_resn,
    output logic           spi_layers_ckdivider_divided_clk,
    output logic            spi_layers_ckdivider_divided_resn,
    input  logic            spi_hk_ckdivider_source_clk,
    input  logic            spi_hk_ckdivider_source_resn,
    output logic           spi_hk_ckdivider_divided_clk,
    output logic            spi_hk_ckdivider_divided_resn,
    output logic [7:0]           layer_0_cfg_ctrl,
    output logic                   layer_0_cfg_ctrl_hold,
    output logic                   layer_0_cfg_ctrl_reset,
    output logic                   layer_0_cfg_ctrl_disable_autoread,
    ...
    output logic                   layer_1_cfg_ctrl_disable_autoread,
    ...
    output logic                   layer_2_cfg_ctrl_disable_autoread,
    ...
    output logic [7:0]           layer_1_status,
    input  logic                   layer_1_status_interruptn,
    input  logic                   layer_1_status_frame_decoding,
    output logic [7:0]           layer_2_status,
    input  logic                   layer_2_status_interruptn,
    input  logic                   layer_2_status_frame_decoding,
    input  logic                  layer_0_stat_frame_counter_enable,
    input  logic                  layer_1_stat_frame_counter_enable,
    input  logic                  layer_2_stat_frame_counter_enable,
    input  logic                  layer_0_stat_idle_counter_enable,
    input  logic                  layer_1_stat_idle_counter_enable,
    input  logic                  layer_2_stat_idle_counter_enable,
    input  logic                  layer_0_stat_wronglength_counter_enable,
    input  logic                  layer_1_stat_wronglength_counter_enable,
    input  logic                  layer_2_stat_wronglength_counter_enable,
    ...
    input  logic                  layer_0_mosi_m_axis_tready,
    output logic            layer_0_mosi_m_axis_tlast,
    input  logic [31:0]            layer_0_mosi_write_size,
    input  logic                  layer_0_mosi_write_size_write,
    ...
    input  logic                  layer_1_mosi_m_axis_tready,
    output logic            layer_1_mosi_m_axis_tlast,
    input  logic [31:0]            layer_1_mosi_write_size,
    input  logic                  layer_1_mosi_write_size_write,
    ...
    input  logic                  layer_2_mosi_m_axis_tready,
    output logic            layer_2_mosi_m_axis_tlast,
    input  logic [31:0]            layer_2_mosi_write_size,
    input  logic                  layer_2_mosi_write_size_write,
    ...
    input  logic                  layer_0_loopback_miso_m_axis_tready,
    input  logic [31:0]            layer_0_loopback_miso_write_size,
    input  logic                  layer_0_loopback_miso_write_size_write,
    ...
    input  logic                  layer_1_loopback_miso_m_axis_tready,
    input  logic [31:0]            layer_1_loopback_miso_write_size,
    input  logic                  layer_1_loopback_miso_write_size_write,
    ...
    input  logic                  layer_2_loopback_miso_m_axis_tready,
    input  logic [31:0]            layer_2_loopback_miso_write_size,
    input  logic                  layer_2_loopback_miso_write_size_write,
    // AXIS Slave interface to read from FIFO layer_0_loopback_mosi,
    // --------------------,
    input  logic [7:0]            layer_0_loopback_mosi_s_axis_tdata,
    input  logic                  layer_0_loopback_mosi_s_axis_tvalid,
    output logic                  layer_0_loopback_mosi_s_axis_tready,
    input  logic [31:0]            layer_0_loopback_mosi_read_size,
    input  logic                  layer_0_loopback_mosi_read_size_write,
    // AXIS Slave interface to read from FIFO layer_1_loopback_mosi,
    // --------------------,
    input  logic [7:0]            layer_1_loopback_mosi_s_axis_tdata,
    input  logic                  layer_1_loopback_mosi_s_axis_tvalid,
    output logic                  layer_1_loopback_mosi_s_axis_tready,
    input  logic [31:0]            layer_1_loopback_mosi_read_size,
    input  logic                  layer_1_loopback_mosi_read_size_write,
    // AXIS Slave interface to read from FIFO layer_2_loopback_mosi,
    // --------------------,
    input  logic [7:0]            layer_2_loopback_mosi_s_axis_tdata,
    input  logic                  layer_2_loopback_mosi_s_axis_tvalid,
    output logic                  layer_2_loopback_mosi_s_axis_tready,
    input  logic [31:0]            layer_2_loopback_mosi_read_size,
    input  logic                  layer_2_loopback_mosi_read_size_write,
    output logic [15:0]           layers_fpga_timestamp_ctrl,
    output logic                   layers_fpga_timestamp_ctrl_enable,
    output logic                   layers_fpga_timestamp_ctrl_use_divider,
    output logic                   layers_fpga_timestamp_ctrl_use_tlu,
    output logic                   layers_fpga_timestamp_ctrl_tlu_busy_on_t0,
    output logic  [1:0]                  layers_fpga_timestamp_ctrl_timestamp_size,
    output logic                   layers_fpga_timestamp_ctrl_force_value,
    output logic                   layers_fpga_timestamp_ctrl_force_lsb_0,
    output logic [31:0]           layers_fpga_timestamp_divider,
    output logic                  layers_fpga_timestamp_divider_interrupt,
    input  logic                  layers_fpga_timestamp_divider_enable,
    input  logic [63:0]            layers_fpga_timestamp_counter,
    output logic [63:0]           layers_fpga_timestamp_forced,
    output logic [15:0]           layers_tlu_trigger_delay,
    output logic [15:0]           layers_tlu_busy_duration,
    output logic [7:0]           layers_cfg_nodata_continue,
    output logic [7:0]           layers_sr_out,
    output logic                   layers_sr_out_ck1,
    output logic                   layers_sr_out_ck2,
    output logic                   layers_sr_out_sin,
    output logic                   layers_sr_out_ld0,
    output logic                   layers_sr_out_ld1,
    output logic                   layers_sr_out_ld2,
    output logic                   layers_sr_out_ldtdac0,
    output logic                   layers_sr_out_ldtdac1,
    output logic                   layers_sr_out_ldtdac2,
    output logic [7:0]           layers_sr_in,
    input  logic                   layers_sr_in_sout0,
    input  logic                   layers_sr_in_sout1,
    input  logic                   layers_sr_in_sout2,
    output logic [7:0]           layers_sr_rb_ctrl,
    output logic                   layers_sr_rb_ctrl_rb,
    output logic                   layers_sr_rb_ctrl_crc_enable,
    output logic  [4:0]                  layers_sr_rb_ctrl_sout_select,
    input  logic [47:0]            layers_sr_crc,
    input  logic                  layers_sr_crc_write,
    // AXIS Slave interface to read from FIFO layers_sr_bytes,
    // --------------------,
    input  logic [7:0]            layers_sr_bytes_s_axis_tdata,
    input  logic                  layers_sr_bytes_s_axis_tvalid,
    output logic                  layers_sr_bytes_s_axis_tready,
    input  logic [31:0]            layers_sr_bytes_read_size,
    input  logic                  layers_sr_bytes_read_size_write,
    output logic [7:0]           layers_inj_ctrl,
    output logic                   layers_inj_ctrl_reset,
    output logic                   layers_inj_ctrl_suspend,
    output logic                   layers_inj_ctrl_synced,
    output logic                   layers_inj_ctrl_trigger,
    output logic                   layers_inj_ctrl_write,
    input  logic                   layers_inj_ctrl_done,
    input  logic                   layers_inj_ctrl_running,
    output logic [3:0]           layers_inj_waddr,
    ...
    input  logic                  layers_readout_s_axis_tvalid,
    output logic                  layers_readout_s_axis_tready,
    input  logic [31:0]            layers_readout_read_size,
    input  logic                  layers_readout_read_size_write,
    output logic [7:0]           io_ctrl,
    output logic                   io_ctrl_reserved0,
    output logic                   io_ctrl_reserved1,
    output logic                   io_ctrl_gecco_sample_clock_se,
    output logic                   io_ctrl_gecco_inj_enable,
    output logic                   io_ctrl_reserved4,
    output logic                   io_ctrl_reserved5,
    output logic [7:0]           io_led,
    output logic [7:0]           gecco_sr_ctrl,
    output logic                   gecco_sr_ctrl_ck,
    output logic                   gecco_sr_ctrl_sin,
    output logic                   gecco_sr_ctrl_ld,
    output logic [31:0]           hk_conversion_trigger_match,
    output logic [31:0]           layers_fpga_timestamp_divider_match
    );
    ...
    logic [7:0] chip_version_reg;
    assign chip_version = chip_version_reg;
    ...
    assign layers_sr_out_ldtdac0 = layers_sr_out_reg[6];
    assign layers_sr_out_ldtdac1 = layers_sr_out_reg[7];
    assign layers_sr_out_ldtdac2 = layers_sr_out_reg[8];
    ...
    always_ff @(posedge clk) begin
        if (!resn) begin
            ...
            rfg_write_valid <= '0;
            if(rfg_write) begin
                unique case(rfg_address)
                    16'h8: begin
                        chip_version_reg[7:0] <= rfg_write_value;
                        rfg_write_valid <= '1;
                    end
                    16'h9: begin
            ...
            if((rfg_write && rfg_address==16'hab)) begin
                hk_conversion_trigger_reg <= 'd0;
            end
            else if(!(rfg_write && rfg_address==16'he)) begin
            ...
            if(hk_stat_conversions_counter_enable) begin
                hk_stat_conversions_counter_reg <= hk_stat_conversions_counter_reg + 'd1 ;
            end
            if(!(rfg_write && rfg_address==16'h25) && layer_0_stat_frame_counter_enable) begin
                layer_0_stat_frame_counter_reg <= layer_0_stat_frame_counter_reg + 'd1 ;
            end
            if(!(rfg_write && rfg_address==16'h29) && layer_1_stat_frame_counter_enable) begin
                layer_1_stat_frame_counter_reg <= layer_1_stat_frame_counter_reg + 'd1 ;
            end
            if(!(rfg_write && rfg_address==16'h2d) && layer_2_stat_frame_counter_enable) begin
                layer_2_stat_frame_counter_reg <= layer_2_stat_frame_counter_reg + 'd1 ;
            end
            if(!(rfg_write && rfg_address==16'h31) && layer_0_stat_idle_counter_enable) begin
                layer_0_stat_idle_counter_reg <= layer_0_stat_idle_counter_reg + 'd1 ;
            end
            if(!(rfg_write && rfg_address==16'h35) && layer_1_stat_idle_counter_enable) begin
                layer_1_stat_idle_counter_reg <= layer_1_stat_idle_counter_reg + 'd1 ;
            end
            if(!(rfg_write && rfg_address==16'h39) && layer_2_stat_idle_counter_enable) begin
                layer_2_stat_idle_counter_reg <= layer_2_stat_idle_counter_reg + 'd1 ;
            end
            if(!(rfg_write && rfg_address==16'h3d) && layer_0_stat_wronglength_counter_enable) begin
                layer_0_stat_wronglength_counter_reg <= layer_0_stat_wronglength_counter_reg + 'd1 ;
            end
            if(!(rfg_write && rfg_address==16'h41) && layer_1_stat_wronglength_counter_enable) begin
                layer_1_stat_wronglength_counter_reg <= layer_1_stat_wronglength_counter_reg + 'd1 ;
            end
            if(!(rfg_write && rfg_address==16'h45) && layer_2_stat_wronglength_counter_enable) begin
                layer_2_stat_wronglength_counter_reg <= layer_2_stat_wronglength_counter_reg + 'd1 ;
            end
            // Counter with interrupt on matching register: If the match register is written, reset the counter
            if((rfg_write && rfg_address==16'haf)) begin
                layers_fpga_timestamp_divider_reg <= 'd0;
            end
            else if(!(rfg_write && rfg_address==16'h78) && layers_fpga_timestamp_divider_enable) begin
    ...
    // Read for FIFO Slave
    // ---------------
    assign hk_adc_miso_fifo_s_axis_tready = rfg_read && rfg_address==16'h18;
    assign layer_0_loopback_mosi_s_axis_tready = rfg_read && rfg_address==16'h67;
    assign layer_1_loopback_mosi_s_axis_tready = rfg_read && rfg_address==16'h6c;
    assign layer_2_loopback_mosi_s_axis_tready = rfg_read && rfg_address==16'h71;
    assign layers_sr_bytes_s_axis_tready = rfg_read && rfg_address==16'h9a;
    assign layers_readout_s_axis_tready = rfg_read && rfg_address==16'ha3;
        ...
        if (!resn) begin
            ...
            if(rfg_read) begin
                unique case(rfg_address)
                    ...
                    16'h8: begin
                        rfg_read_value <= chip_version_reg[7:0];
                        rfg_read_valid <= '1 ;
                    end
                    16'h9: begin
                    ...
                    16'h18: begin
                        rfg_read_value <= hk_adc_miso_fifo_s_axis_tvalid ? hk_adc_miso_fifo_s_axis_tdata : '1;
                        rfg_read_valid <= '1;
                    end
                    16'h19: begin
                    ...
                    16'h67: begin
                        rfg_read_value <= layer_0_loopback_mosi_s_axis_tvalid ? layer_0_loopback_mosi_s_axis_tdata : '1;
                        rfg_read_valid <= '1;
                    end
                    16'h68: begin
                    ...
                    16'h6c: begin
                        rfg_read_value <= layer_1_loopback_mosi_s_axis_tvalid ? layer_1_loopback_mosi_s_axis_tdata : '1;
                        rfg_read_valid <= '1;
                    end
                    16'h6d: begin
                    ...
                    16'h71: begin
                        rfg_read_value <= layer_2_loopback_mosi_s_axis_tvalid ? layer_2_loopback_mosi_s_axis_tdata : '1;
                        rfg_read_valid <= '1;
                    end
                    16'h72: begin
                    ...
                    16'h9a: begin
                        rfg_read_value <= layers_sr_bytes_s_axis_tvalid ? layers_sr_bytes_s_axis_tdata : '1;
                        rfg_read_valid <= '1;
                    end
                    16'h9b: begin
                    ...
                    16'ha3: begin
                        rfg_read_value <= layers_readout_s_axis_tvalid ? layers_readout_s_axis_tdata : '1;
                        rfg_read_valid <= '1;
                    end
                    16'ha4: begin
    ...
    always_ff@(posedge spi_layers_ckdivider_source_clk) begin
        if (!spi_layers_ckdivider_source_resn) begin
            ...
            spi_layers_ckdivider_counter <= '0;
        end else begin
    ...
    always_ff@(posedge spi_layers_ckdivider_divided_clk or negedge spi_layers_ckdivider_source_resn) begin
        if (!spi_layers_ckdivider_source_resn) begin
            spi_layers_ckdivider_divided_resn_delay <= '0;
        end else begin
    ...
    always_ff@(posedge spi_hk_ckdivider_divided_clk or negedge spi_hk_ckdivider_source_resn) begin
        if (!spi_hk_ckdivider_source_resn) begin
            spi_hk_ckdivider_divided_resn_delay <= '0;
        end else begin
    ...
    always_ff@(posedge clk) begin
        if (!resn) begin
            ...
            rfg_address_valid <= rfg_address >= 'd0 && rfg_address <= 'hb2;
        end
    end
