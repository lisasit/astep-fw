module main_rfg(
    ...
    always_ff @(posedge clk) begin
        if (!resn) begin
            ...
            if(rfg_write && rfg_address==16'h17) begin
            ...
            if(rfg_write && rfg_address==16'h49) begin
            ...
            if(rfg_write && rfg_address==16'h4e) begin
            ...
            if(rfg_write && rfg_address==16'h53) begin
