...
async def main():
    ...
    ## driver = drivers.boards.getGeccoUARTDriver("/dev/ttyUSB0")
    #driver = drivers.boards.getGeccoFTDIDriver()
    #await driver.open()
    ...
    currentTS = await driver.rfg.read_layers_fpga_timestamp_counter(count=4)
    logger.info(f'FPGA TS = {currentTS}')
